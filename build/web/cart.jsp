                        ...
                        <div class="row">
                                                ...
                                                <div class="info">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 quantity">
                                                            ...
                                                            <input id="quantity" type="number" value ="${o.quantityUser}" class="form-control quantity-input">
                                                        </div>
                            ...
                            <div class="col-md-12 col-lg-4">
                                <div class="summary">
                                    ...
                                    <a href="URLcheckOut?order=removeAll"><button type="button" class="btn btn-primary btn-lg btn-block">Remove All</button></a>
                                </div>
                            </div>
                        </div> 
                    </div>
