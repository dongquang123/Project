                    ...
                    <tbody>
                        <c:forEach items="${listCustomer}" var="o">
                            <tr>
                                ...
                                <td>
                                    <a href="URLmanageCustomer?manageCus=banCustomer&user_id=${o.user_id}" class="delete" data-toggle="modal"><i class="fas fa-ban"></i></a>
                                    <a href="URLmanageCustomer?manageCus=unbanCustomer&user_id=${o.user_id}" class="delete" data-toggle="modal">Unbanned</a>
                                    <a href="URLmanageCustomer?manageCus=changeAdmin&user_id=${o.user_id}" class="delete" data-toggle="modal">Change Admin</a>
