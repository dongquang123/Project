...
public class Product {
    ...
    public Product(int product_id, String product_name, double price, int quantity, String description, String image_url, int brand_id, String release_date, int quantityUser) {
