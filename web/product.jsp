<%-- 
    Document   : product
    Created on : Jun 27, 2024, 8:58:07 AM
    Author     : Fantasy
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="entity.Product,java.util.Enumeration,java.util.Vector"%>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="breadcrumb-tree">
                            ...
                            <li><a href="URLProduct?Type=allCategories">All Categories</a></li>
                            <li><a href="URLProduct?Type=${name}">${name}</a></li>
                            <li class="active"><%=detail.getProduct_name()%></li>
                        </ul>
                    </div>
                </div>
                <!-- /row -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 col-md-push-2">
                        <div id="product-main-img">
                            <div class="product-preview">
                                <img src="./img/<%=detail.getImage_url()%>" alt="">
                            </div>

                            <div class="product-preview">
                                <img src="./img/2<%=detail.getImage_url()%>" alt="">
                            </div>

                            <div class="product-preview">
                                <img src="./img/3<%=detail.getImage_url()%>" alt="">
                            </div>

                            <div class="product-preview">
                                <img src="./img/4<%=detail.getImage_url()%>" alt="">
                            </div>
                        </div>
                    </div>
                    <!-- /Product main img -->
                    ...
                    <div class="col-md-5">
                        <div class="product-details">
                            <h2 class="product-name"><%=detail.getProduct_name()%></h2>
                            <div>
                            ...
                            <div>
                                <h3 class="product-price"><%=detail.getPrice()%></h3>
                            ...
                            <div class="add-to-cart">
                                ...
                                <button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="URLcart?service=add2cart&product_id=<%=detail.getProduct_id()%>" style="color: white"> add to cart</a></button>
                            </div>

                            <ul class="product-btns">
                                <li><a href="URLwishList?service=like&product_id=<%=detail.getProduct_id()%>"><i class="fa fa-heart-o"></i> add to wishlist</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- /Product details -->
        ...
        <div class="section">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <!-- product -->
                    <c:forEach items="${relate}" var="o">
                    <div class="col-md-3 col-xs-6">
                        <div class="product">
                            <div class="product-img">
                                <img src="./img/${o.image_url}" alt="">
